        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div>
            ...
            <p className="text-lg text-gray-400 mb-8">
              Hi, I&apos;m Tundra. An experienced developer specializing in Node.js, with skills across various programming languages. I create flexible and effective solutions for diverse needs, focusing on innovation and quality to support entrepreneurs and propel their projects. Currently, I&apos;m one of the lead developers at Stratos Tech.
            </p>
